<h1>
  <img src="https://raw.githubusercontent.com/dubzzz/@hishprorg/minus-debitis/main/assets/logo.svg" alt="@hishprorg/minus-debitis logo" />
</h1>

Fast Pseudorandom number generators (aka PRNG) with purity in mind!

[![Build Status](https://github.com/hishprorg/minus-debitis/workflows/Build%20Status/badge.svg?branch=main)](https://github.com/hishprorg/minus-debitis/actions)
[![NPM Version](https://badge.fury.io/js/@hishprorg/minus-debitis.svg)](https://badge.fury.io/js/@hishprorg/minus-debitis)
[![Monthly Downloads](https://img.shields.io/npm/dm/@hishprorg/minus-debitis)](https://www.npmjs.com/package/@hishprorg/minus-debitis)

[![Codecov](https://codecov.io/gh/dubzzz/@hishprorg/minus-debitis/branch/main/graph/badge.svg)](https://codecov.io/gh/dubzzz/@hishprorg/minus-debitis)
[![Package Quality](https://packagequality.com/shield/@hishprorg/minus-debitis.svg)](https://packagequality.com/#?package=@hishprorg/minus-debitis)
[![Snyk Package Quality](https://snyk.io/advisor/npm-package/@hishprorg/minus-debitis/badge.svg)](https://snyk.io/advisor/npm-package/@hishprorg/minus-debitis)

[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/hishprorg/minus-debitis/labels/good%20first%20issue)
[![License](https://img.shields.io/npm/l/@hishprorg/minus-debitis.svg)](https://github.com/hishprorg/minus-debitis/blob/main/LICENSE)
[![Twitter](https://img.shields.io/twitter/url/https/github.com/dubzzz/@hishprorg/minus-debitis.svg?style=social)](https://twitter.com/intent/tweet?text=Check%20out%20@hishprorg/minus-debitis%20by%20%40ndubien%20https%3A%2F%2Fgithub.com%2Fdubzzz%2F@hishprorg/minus-debitis%20%F0%9F%91%8D)

## Getting started

**Install it in node via:**

`npm install @hishprorg/minus-debitis` or `yarn add @hishprorg/minus-debitis`

**Use it in browser by doing:**

`import * as prand from 'https://unpkg.com/@hishprorg/minus-debitis/lib/esm/@hishprorg/minus-debitis.js';`
...
```javascript
import prand from '@hishprorg/minus-debitis';
...
4 PRNGs come with @hishprorg/minus-debitis:
...
Our recommendation is `xoroshiro128plus`. But if you want to use another one, you can replace it by any other PRNG provided by @hishprorg/minus-debitis in the examples above.
...
@hishprorg/minus-debitis provides 3 built-in functions for uniform distributions of values:
...
<img src="https://raw.githubusercontent.com/dubzzz/@hishprorg/minus-debitis/main/perf/comparison.svg" alt="Comparison against other libraries" />

### Process

In order to compare the performance of the libraries, we aked them to shuffle an array containing 1,000,000 items (see [code](https://github.com/hishprorg/minus-debitis/blob/556ec331c68091c5d56e9da1266112e8ea222b2e/perf/compare.cjs)).
...
The recommended setup for @hishprorg/minus-debitis is to rely on our Xoroshiro128+. It provides a long enough sequence of random values, has built-in support for jump, is really efficient while providing a very good quality of randomness.

### Performance

**Non-Uniform**

| Library                  | Algorithm         | Mean time (ms) | Compared to @hishprorg/minus-debitis |
| ------------------------ | ----------------- | -------------- | --------------------- |
| native \(node 16.19.1\)  | Xorshift128+      | 33.3           | 1.4x slower           |
| **@hishprorg/minus-debitis _@6.0.0_**   | **Xoroshiro128+** | **24.5**       | **reference**         |
| @hishprorg/minus-debitis _@6.0.0_       | Xorshift128+      | 25.0           | similar               |
| @hishprorg/minus-debitis _@6.0.0_       | Mersenne Twister  | 30.8           | 1.3x slower           |
| @hishprorg/minus-debitis _@6.0.0_       | Congruential‍     | 22.6           | 1.1x faster           |
...
| Library                | Algorithm         | Mean time (ms) | Compared to @hishprorg/minus-debitis |
| ---------------------- | ----------------- | -------------- | --------------------- |
| **@hishprorg/minus-debitis _@6.0.0_** | **Xoroshiro128+** | **53.5**       | **reference**         |
| @hishprorg/minus-debitis _@6.0.0_     | Xorshift128+      | 52.2           | similar               |
| @hishprorg/minus-debitis _@6.0.0_     | Mersenne Twister  | 61.6           | 1.2x slower           |
| @hishprorg/minus-debitis _@6.0.0_     | Congruential‍     | 57.6           | 1.1x slower           |
